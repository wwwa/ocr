...
from ...detect.ctpn.ctpn_detect import text_detect
from ...detect.ctpn.lib.fast_rcnn.config import cfg_from_file
from .char_rec import predict as keras_densenet
...
def rec_keras(img, adjust=False):
    """
    @img: 图片
    @adjust: 是否调整文字识别结果
    """
